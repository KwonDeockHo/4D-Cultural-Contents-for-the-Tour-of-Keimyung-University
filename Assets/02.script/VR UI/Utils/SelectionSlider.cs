...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
        ...
        [SerializeField]
        private float m_Duration = 3f;                 // The length of time it takes for the bar to fill.
        [SerializeField]
        ...
        private float m_Timer = 0;                                              // Used to determine how much of the bar should be filled.
