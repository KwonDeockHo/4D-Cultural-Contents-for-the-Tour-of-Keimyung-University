...
namespace VRStandardAssets.Utils
{
    ...
    public class VRInteractiveItem : MonoBehaviour
    {
        ...
        public static VRInteractiveItem instance = null;


        protected bool m_IsOver;

        public static VRInteractiveItem Instance
        {
            get
            {
                if (instance == null)
                {//= new CGame();
                    instance = FindObjectOfType(typeof(VRInteractiveItem)) as VRInteractiveItem;
                }
                return instance;
            }
        }
