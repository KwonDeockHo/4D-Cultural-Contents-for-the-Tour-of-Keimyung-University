...
public class steg : MonoBehaviour
{
	...
	const float MAXYAW=25, MAXPITCH=10, MAXCROUCH=4, MAXANG=1.5f, TANG=0.025f;
	...
	//*************************************************************************************************************************************************
	//Check collisions
	void OnCollisionStay(Collision col) { shared.ManageCollision(col, MAXPITCH, MAXCROUCH, source, Steg1, Hit_jaw, Hit_head, Hit_tail); }
	...
	void FixedUpdate ()
	{
		...
		{
			body.mass=5; body.drag=1; body.angularDrag=1; anm.speed=shared.AnimSpeed/2; anm.Play("Steg|Run");
		...
		else if(CurrAnm.IsName("Steg|Atk1-") | CurrAnm.IsName("Steg|Atk1+") | CurrAnm.IsName("Steg|Atk2-") | CurrAnm.IsName("Steg|Atk2+"))
		{
			...
			{
				if(CurrAnm.IsName("Steg|Atk1-")) transform.rotation*= Quaternion.Euler(0, Mathf.Lerp(0, -10.0f, 0.5f), 0);
				else if(CurrAnm.IsName("Steg|Atk2+")) transform.rotation*= Quaternion.Euler(0, Mathf.Lerp(0, -7.0f, 0.5f), 0);
				else if(CurrAnm.IsName("Steg|Atk2-")) transform.rotation*= Quaternion.Euler(0, Mathf.Lerp(0, 7.0f, 0.5f), 0);
				else if(CurrAnm.IsName("Steg|Atk1+")) transform.rotation*= Quaternion.Euler(0, Mathf.Lerp(0, 10.0f, 0.5f), 0);
			}
		...
		else if(CurrAnm.IsName("Steg|Die1-")) { PlaySound("Growl", 3); transform.tag=("Dino"); shared.IsDead=false; }
		else if(CurrAnm.IsName("Steg|Die2-")) { PlaySound("Growl", 3); transform.tag=("Dino"); shared.IsDead=false; }
	}
