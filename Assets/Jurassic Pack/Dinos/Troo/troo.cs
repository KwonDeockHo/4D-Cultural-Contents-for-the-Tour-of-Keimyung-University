...
public class troo : MonoBehaviour
{
	...
	void Start()
	{
		Right_Hips = transform.Find ("Troo/root/pelvis/right leg0");
		Right_Leg = transform.Find ("Troo/root/pelvis/right leg0/right leg1");
		Right_Foot0 = transform.Find ("Troo/root/pelvis/right leg0/right leg1/right foot0");
		Right_Foot1 = transform.Find ("Troo/root/pelvis/right leg0/right leg1/right foot0/right foot1");
		Left_Hips = transform.Find ("Troo/root/pelvis/left leg0");
		Left_Leg = transform.Find ("Troo/root/pelvis/left leg0/left leg1");
		Left_Foot0 = transform.Find ("Troo/root/pelvis/left leg0/left leg1/left foot0");
		Left_Foot1 = transform.Find ("Troo/root/pelvis/left leg0/left leg1/left foot0/left foot1");
		
		Tail0 = transform.Find ("Troo/root/pelvis/tail0");
		Tail1 = transform.Find ("Troo/root/pelvis/tail0/tail1");
		Tail2 = transform.Find ("Troo/root/pelvis/tail0/tail1/tail2");
		Tail3 = transform.Find ("Troo/root/pelvis/tail0/tail1/tail2/tail3");
		Tail4 = transform.Find ("Troo/root/pelvis/tail0/tail1/tail2/tail3/tail4");
		Tail5 = transform.Find ("Troo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5");
		Tail6 = transform.Find ("Troo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6");
		Tail7 = transform.Find ("Troo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7");
		Tail8 = transform.Find ("Troo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8");
		Tail9 = transform.Find ("Troo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8/tail9");
		Tail10 = transform.Find ("Troo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8/tail9/tail10");
		Tail11 = transform.Find ("Troo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8/tail9/tail10/tail11");
		Spine0 = transform.Find ("Troo/root/spine0");
		Spine1 = transform.Find ("Troo/root/spine0/spine1");
		Spine2 = transform.Find ("Troo/root/spine0/spine1/spine2");
		Spine3 = transform.Find ("Troo/root/spine0/spine1/spine2/spine3");
		Spine4 = transform.Find ("Troo/root/spine0/spine1/spine2/spine3/spine4");
		Spine5 = transform.Find ("Troo/root/spine0/spine1/spine2/spine3/spine4/spine5");
		Arm1  = transform.Find ("Troo/root/spine0/spine1/spine2/spine3/spine4/spine5/left arm0");
		Arm2  = transform.Find ("Troo/root/spine0/spine1/spine2/spine3/spine4/spine5/right arm0");
		Neck0 = transform.Find ("Troo/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0");
		Neck1 = transform.Find ("Troo/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1");
		Neck2 = transform.Find ("Troo/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1/neck2");
		Neck3 = transform.Find ("Troo/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1/neck2/neck3");
		Head  = transform.Find ("Troo/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1/neck2/neck3/head");
	...
	//*************************************************************************************************************************************************
	//Check collisions
	void OnCollisionStay(Collision col) { shared.ManageCollision(col, MAXPITCH, MAXCROUCH, source, Troo4, Hit_jaw, Hit_head, Hit_tail); }
	...
	void FixedUpdate()
	{
		...
		{
			body.mass=5; body.drag=1; body.angularDrag=1; anm.speed=shared.AnimSpeed/2; anm.Play("Troo|Run"); shared.Health-=0.1f;
		...
		//Stopped
		if(NextAnm.IsName("Troo|IdleA") | CurrAnm.IsName("Troo|IdleA") | CurrAnm.IsName("Troo|Die"))
		{
			if(CurrAnm.IsName("Troo|Die")) { reset=true; shared.IsConstrained=true; if(!shared.IsDead) { PlaySound("AtkB", 2); PlaySound("Die", 12); } }
		}

		//Jump
		else if(CurrAnm.IsName("Troo|IdleJumpStart") | CurrAnm.IsName("Troo|RunJumpStart") | CurrAnm.IsName("Troo|JumpIdle") |
			CurrAnm.IsName("Troo|IdleJumpEnd") | CurrAnm.IsName("Troo|RunJumpEnd") | CurrAnm.IsName("Troo|JumpAtk"))
		{
			transform.rotation*= Quaternion.Euler(0, anm.GetFloat("Turn")*2, 0);
			if(CurrAnm.IsName("Troo|IdleJumpStart") | CurrAnm.IsName("Troo|RunJumpStart"))
			{
				PlaySound("Step", 1); PlaySound("Step", 2);
				if(CurrAnm.normalizedTime > 0.4) body.AddForce(Vector3.up*260*transform.localScale.x); 
				if(CurrAnm.IsName("Troo|RunJumpStart")) body.AddForce(dir*160*transform.localScale.x*anm.speed);
			}
			else if(CurrAnm.IsName("Troo|IdleJumpEnd") | CurrAnm.IsName("Troo|RunJumpEnd"))
			{ 
				body.drag=4; body.velocity = new Vector3(body.velocity.x, 0, body.velocity.z);
				if(CurrAnm.IsName("Troo|RunJumpEnd")) body.AddForce(transform.forward*160*transform.localScale.x*anm.speed);
				PlaySound("Step", 3); PlaySound("Step", 4); 
			}
			else { body.drag=0.1f; if(CurrAnm.IsName("Troo|JumpAtk")) { shared.IsAttacking=true; PlaySound("AtkB", 1); PlaySound("Bite", 9); } }
		}

		//Forward
		else if(NextAnm.IsName("Troo|Walk") | CurrAnm.IsName("Troo|Walk") | CurrAnm.IsName("Troo|WalkGrowl"))
		{
			transform.rotation*= Quaternion.Euler(0, anm.GetFloat("Turn")*2, 0);
			body.AddForce(transform.forward*32*transform.localScale.x*anm.speed);
			if(CurrAnm.IsName("Troo|Walk")){ PlaySound("Step", 6); PlaySound("Step", 14);}
			else if(CurrAnm.IsName("Troo|WalkGrowl")) { PlaySound("Growl", 2); PlaySound("Step", 6); PlaySound("Step", 14); }
		}

		//Running
		else if(NextAnm.IsName("Troo|Run") | CurrAnm.IsName("Troo|Run") |
		   CurrAnm.IsName("Troo|RunGrowl") | CurrAnm.IsName("Troo|RunAtk1") |
		   (CurrAnm.IsName("Troo|RunAtk2") && CurrAnm.normalizedTime < 0.9) |
		   (CurrAnm.IsName("Troo|IdleAtk3") && CurrAnm.normalizedTime > 0.5 && CurrAnm.normalizedTime < 0.9))
		{
			transform.rotation*= Quaternion.Euler(0, anm.GetFloat("Turn")*2, 0);
			body.AddForce(transform.forward*160*transform.localScale.x*anm.speed);
			if(CurrAnm.IsName("Troo|Run")){ PlaySound("Step", 4); PlaySound("Step", 12); }
			else if(CurrAnm.IsName("Troo|RunGrowl")) { PlaySound("AtkB", 2); PlaySound("Step", 4); PlaySound("Step", 12); }
			else if( CurrAnm.IsName("Troo|RunAtk1")) { shared.IsAttacking=true; PlaySound("AtkB", 2); PlaySound("Step", 4); PlaySound("Step", 12); }
			else if( CurrAnm.IsName("Troo|RunAtk2")| CurrAnm.IsName("Troo|IdleAtk3"))
			{ shared.IsAttacking=true; PlaySound("AtkA", 2); PlaySound("Step", 4); PlaySound("Bite", 9); PlaySound("Step", 12); }
		}
		
		//Backward
		else if(NextAnm.IsName("Troo|Walk-") | NextAnm.IsName("Troo|WalkGrowl-") |
					CurrAnm.IsName("Troo|Walk-") | CurrAnm.IsName("Troo|WalkGrowl-"))
		{
			...
			if(CurrAnm.IsName("Troo|WalkGrowl-")) { PlaySound("Growl", 1); PlaySound("Step", 6); PlaySound("Step", 13); }
			else { PlaySound("Step", 6); PlaySound("Step", 13); }
		}

		//Strafe/Turn right
		else if(NextAnm.IsName("Troo|Strafe-") | CurrAnm.IsName("Troo|Strafe-"))
		{
			transform.rotation*= Quaternion.Euler(0, anm.GetFloat("Turn")*2, 0);
		...
		//Various
		else if(CurrAnm.IsName("Troo|IdleAtk3")) { shared.IsAttacking=true; transform.rotation*= Quaternion.Euler(0, anm.GetFloat("Turn")*2, 0); PlaySound("AtkB", 1); }
		else if(CurrAnm.IsName("Troo|GroundAtk")) { shared.IsAttacking=true; PlaySound("AtkB", 2); PlaySound("Bite", 4); }
		else if(CurrAnm.IsName("Troo|IdleAtk1") | CurrAnm.IsName("Troo|IdleAtk2"))
		{ shared.IsAttacking=true; transform.rotation*= Quaternion.Euler(0, anm.GetFloat("Turn")*2, 0); PlaySound("AtkB", 2); PlaySound("Bite", 9); }
		else if(CurrAnm.IsName("Troo|ToSleep")) { reset=true; shared.IsConstrained=true; }
		else if(CurrAnm.IsName("Troo|Sleep")) { reset=true; PlaySound("Sleep", 1); shared.IsConstrained=true;}
		else if(CurrAnm.IsName("Troo|EatA")) { reset=true; PlaySound("Eat", 1); }
		else if(CurrAnm.IsName("Troo|EatB")) { reset=true; PlaySound("Bite", 3); }
		else if(CurrAnm.IsName("Troo|EatC")) reset=true;
		else if(CurrAnm.IsName("Troo|IdleC")) PlaySound("Growl", 1);
		else if(CurrAnm.IsName("Troo|IdleD")) { PlaySound("Call", 1); PlaySound("Call", 4); PlaySound("Call", 8); }
		else if(CurrAnm.IsName("Troo|IdleE")) { reset=true; PlaySound("Bite", 4); PlaySound("Bite", 7); PlaySound("Bite", 9); }
		else if(CurrAnm.IsName("Troo|Die-")) { reset=true; PlaySound("AtkA", 1); transform.tag=("Dino"); shared.IsDead=false; }
	}
