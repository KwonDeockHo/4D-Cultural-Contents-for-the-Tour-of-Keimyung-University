...
[ExecuteInEditMode]
public class JPWater4 : MonoBehaviour
{
  ...
  public bool EdgeBlend = true;
	...
	void Update()
	{
		if(WaterMaterial)
		{
			...
			if(DirectionalLight) WaterMaterial.SetVector("_WorldLightDir", DirectionalLight.transform.forward);
	...
	void OnWillRenderObject()
	{
		...
		//if(reflectionCamera.transform.position.x!=0 && reflectionCamera.transform.position.y!=0 && reflectionCamera.transform.position.z!=0)
